...
fn main() {
  ...
  .arg(clap::arg!(--"show-outputs" "Explicitly print outputs even if no other flag connected to outputs is in use."))
  .arg(clap::arg!(--"show-seat" "Explicitly print seat even if no other flag connected to seat is in use."))
