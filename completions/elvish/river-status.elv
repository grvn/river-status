...
set edit:completion:arg-completer[river-status] = {|@words|
    ...
    var completions = [
        &'river-status'= {
            ...
            cand --show-outputs 'Explicitly print outputs even if no other flag connected to outputs is in use.'
            cand --show-seat 'Explicitly print seat even if no other flag connected to seat is in use.'
